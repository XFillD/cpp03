...
{
    if (this->_health <= 0)
        std::cout << "\033[31mScavTrap " << this->_alias << " is not able to attack " << target << ", because he has not enough hit points.\033[0m" << std::endl;
    else if (this->_energy == 0)
        std::cout << "\033[31mScavTrap " << this->_alias << " is not able to attack " << target << ", because he has no energy points left.\033[0m" << std::endl;
    else
    {
        std::cout << "ScavTrap " << this->_alias << " attacks " << target << ", causing " << this->_power << " points of damage!" << std::endl;
        this->_energy--;
    }
}
